...
$sql = "SELECT * FROM biryanis WHERE category='chole'";
...
<div class="container">
  <h2 class="heading"><i class="fas fa-drumstick-bite"></i> Chole Bhature Specials - Taste the Royalty!</h2>
  <div class="row g-4">
